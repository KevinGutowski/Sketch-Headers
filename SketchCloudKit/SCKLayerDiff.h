...
{
    SCKLayer *_object;
    SCKLayer *_comparedObject;
    unsigned long long _attributes;
}

@property(readonly, nonatomic) unsigned long long attributes; // @synthesize attributes=_attributes;
@property(readonly, copy, nonatomic) SCKLayer *comparedObject; // @synthesize comparedObject=_comparedObject;
@property(readonly, copy, nonatomic) SCKLayer *object; // @synthesize object=_object;
- (void).cxx_destruct;
