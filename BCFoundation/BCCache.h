...
- (id)populateCacheForObjectWithOwner:(id)arg1 andKey:(id)arg2 creationBlock:(CDUnknownBlockType)arg3;
- (id)cachedObjectForOwner:(id)arg1 andKey:(id)arg2 orCreateWithBlock:(CDUnknownBlockType)arg3;
- (id)blockingCachedObjectForOwner:(id)arg1 andKey:(id)arg2 orCreateWithBlock:(CDUnknownBlockType)arg3;
